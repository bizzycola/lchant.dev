<template>
    <section class="text-gray-400 body-font dark-bg min-h-screen" id="projects">
            ...
            <div class="flex flex-wrap -m-4">
                ...
                <div class="xl:w-1/3 md:w-1/2 p-4">
                    <div class="border border-gray-700 border-opacity-75 p-6 rounded-lg">
                        ...
                        <h2 class="text-lg text-white font-medium title-font mb-2">
                            <a href="https://codebyte.cafe" target="_blank">CodeByte</a>
                        </h2>
                        <p
                            class="leading-relaxed text-base"
                        >Social Media site for people in IT and STEM fields, themed like a cafe hangout place. Currently invite only, contact me for further information.</p>
                    </div>
                </div>
                <div class="xl:w-1/3 md:w-1/2 p-4">
                    <div class="border border-gray-700 border-opacity-75 p-6 rounded-lg">
                        ...
                        <h2 class="text-lg text-white font-medium title-font mb-2">
                            <a
                                href="https://github.com/bizzycola/MidiGameBoi"
                                target="_blank"
                            >MidiGameBoi</a>
                        </h2>
                        <p
                            class="leading-relaxed text-base"
                        >Simple, configurable .NET program to convert MIDI notes from devices(midi keyboards, etc) to keyboard/mouse events.</p>
                    </div>
                </div>
                <div class="xl:w-1/3 md:w-1/2 p-4">
                    <div class="border border-gray-700 border-opacity-75 p-6 rounded-lg">
                        ...
                        <h2 class="text-lg text-white font-medium title-font mb-2">TaskRunner</h2>
                        <p
                            class="leading-relaxed text-base"
                        >Precursor to Deployr, ran commands based on shell scripts as opposed to docker.</p>
                    </div>
                </div>
                <div class="xl:w-1/3 md:w-1/2 p-4">
                    <div class="border border-gray-700 border-opacity-75 p-6 rounded-lg">
                        ...
                        <h2 class="text-lg text-white font-medium title-font mb-2">Discord & Twitch</h2>
                        <p
                            class="leading-relaxed text-base"
                        >I've built a variety of Discord and Twitch chat bots for communities. Freelance services available.</p>
                    </div>
                </div>
                <div class="xl:w-1/3 md:w-1/2 p-4">
                    <div class="border border-gray-700 border-opacity-75 p-6 rounded-lg">
